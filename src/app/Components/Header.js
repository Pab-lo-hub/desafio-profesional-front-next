        ...
        <header className="fixed top-0 left-0 w-full bg-white shadow-md z-50">
            <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between p-1 lg:px-4">
                ...
                <div className="hidden lg:flex lg:flex-1 lg:justify-end">
                    <a href="#" className="bg-transparent hover:bg-blue-400 text-blue-400 font-semibold hover:text-white py-2 px-4 border border-blue-300 hover:border-transparent rounded mr-4">
                        Crear Cuenta
                    </a>
                    <a href="#" className="bg-transparent hover:bg-blue-400 text-blue-400 font-semibold hover:text-white py-2 px-4 border border-blue-300 hover:border-transparent rounded">
                        Iniciar Sesión
                    </a>
                </div>
            </nav>
